...
type FormDataError = Omit<FormData, 'confirm_password'>
...
export default function ChangePassword() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      console.log(omit(data, ['confirm_password']))
        ...
        if (formError) {
          Object.keys(formError).forEach((key) => {
            ...
            if (typeof errorMessage === 'string' || errorMessage === undefined) {
              ...
              console.warn(`Giá trị lỗi không hợp lệ cho khóa ${key}:`, errorMessage)
              // Hoặc xử lý theo cách khác nếu giá trị không phải string hoặc undefined
            }
          })
        }
      }
